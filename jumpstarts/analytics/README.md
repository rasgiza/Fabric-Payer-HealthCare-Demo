...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="../../assets/images/diagrams/analytics_dark.svg">
  <img alt="Analytics Accelerator (Tier 2) architecture" src="../../assets/images/diagrams/analytics_light.svg">
</picture>
...
> with slug `analytics`, then drop the downloaded
> `analytics_light.svg` / `analytics_dark.svg` into
