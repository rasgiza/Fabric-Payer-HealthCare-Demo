...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="../../assets/images/diagrams/fabric-iq-rti_dark.svg">
  <img alt="Fabric IQ + Foundry IQ + RTI Accelerator (Tier 3) architecture" src="../../assets/images/diagrams/fabric-iq-rti_light.svg">
</picture>
...
> with slug `fabric-iq-rti`, then drop the downloaded
> `fabric-iq-rti_light.svg` / `fabric-iq-rti_dark.svg` into
